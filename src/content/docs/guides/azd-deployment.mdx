...
| Existing project without `azure.yaml` | **azd** (generate azure.yaml) | Generate `azure.yaml` via apex-azure-prepare, then use azd |
...
│   ├── plan.md             # apex-azure-prepare output — source of truth
...
The **apex-azure-prepare** skill generates infrastructure code and the deployment plan.
...
The **apex-azure-validate** skill runs pre-deployment checks.
...
The **apex-azure-deploy** skill executes the deployment.
